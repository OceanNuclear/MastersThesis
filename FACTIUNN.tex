...
Among all neural network trained on fission which achieved the best MSE value of 5.0178, and was obtained using %(MSE defined in log space, (eq.~\ref{MSE}))
...
When trained on fission spectra, 16.767817 %Also gives nonsensical results.
