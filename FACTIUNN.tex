...
To demonstrate that the neural network is capable of doing the unfolding procedure in an underdetermined condition, 1800 spectra were made to train the neural network. They are generated from 300
...
\centering
    ...
    \begin{subfigure}[b]{.65\linewidth}
        ...
        \caption{300 $\times$ 6 perturbed spectra were generated for each of the 6 original fusion spectra and plotted here, in flux per unit lethargy.}
    \end{subfigure}
